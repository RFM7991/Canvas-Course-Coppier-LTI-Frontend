...
app.get('/', (req, res) => {
    ...
    console.log('OAuth')
  //  'https://learn-lti.herokuapp.com/login/oauth2/auth?client_id=' + client_id + '&response_type=' + response_type + '&redirect_uri=' + redirect_uri 
 // 'https://learn-lti.herokuapp.com/login/oauth2/auth?client_id=5498&response_type=code&redirect_uri=https://localhost:3000 
   // res.redirect('https://montclair.instructure.com/login/oauth2/auth?client_id=XXX&response_type=code&state=YYY&redirect_uri=https://example.com/oauth_complete')
