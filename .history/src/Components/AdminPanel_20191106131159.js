...
class AdminPanel extends React.Component {
  ...
  render() {
      ...
      if (this.state.userInfo !== undefined && this.state.courseInfo !== undefined)
        ...
        <h3 style={{color: 'whitesmoke'}}>Sorry, this course is not registered for Candroid.</h3>
        <p style={{color: 'whitesmoke'}}>Please Contact the IT Help Desk to enable candroid for your course.</p>
      </div>
    return (
