...
class MyForm extends React.Component {
   ...
   async handleSubmit() {
      if (this.state.actionTaken) {
        ...
        let response  = await updateCourse(this.props.userInfo.courseId, this.state.checked, this.state.teacherThreshold, this.state.studentThreshold)
      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '40%', margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px'}}>
          ...
          <tr>  
              ...
              <td> 
                    <Form.Control as="select" name="teacher_threshold" value={this.state.teacherThreshold}>
              ...
              <td> 
                    <Form.Control as="select" name="student_threshold" value={this.state.studentThreshold} >
                        <option key={1}>1</option>
                        <option key={2}>2</option>
                        <option key={3}>3</option>
                        <option key={4}>4</option>
