...
class Report extends React.Component {
    ...
    render() {
      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%',  margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          
          <br></br>
          <div style={{  justifyItems: 'space-between'}}>
            <span style={{ color: 'whitesmoke', alignSelf: 'flex-start'}}>Student Log Report for {this.props.courseInfo.short_name}</span>
           
            <Button style={{fontSize: '12px', alignSelf: 'flex-end', marginLeft: '20%'}}
                    variant="secondary"
