        ...
        <div style={{ fontFamily: 'arial, sans-serif', width: '40%', margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px'}}>
          ...
          <tr>
              ...
              <td> 
                        ...
                        <Form.Control as="select" name="priceLevel" onChange={this.onPriceFormChange}>
                        <option key={1}>1 (Discount)</option>
                        <option key={2}>2 (Moderate)</option>
                        <option key={3}>3 (Expensive)</option>
                        <option key={4}>4 (Luxury)</option>
