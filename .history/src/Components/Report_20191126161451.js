    ...
    render() {
      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', height: '100%', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          ...
          <br></br>
          <div style={{ width: '100%', justifyItems: 'space-between'}}>
            <span style={{ color: 'whitesmoke', float: 'left'}}><strong></strong>Student Log Report for {this.props.courseInfo.short_name}</strong></span>
   
            <Button style={{fontSize: '12px', float: 'right', marginBottom: '8px'}}
                    variant="secondary"
