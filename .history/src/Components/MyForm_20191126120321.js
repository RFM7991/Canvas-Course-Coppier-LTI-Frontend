...
class MyForm extends React.Component {
   ...
   async handleSubmit() {
    ...
    render() {
      return (
        <div style={{ backgroundColor: 'red', width: '40%', margin: 'auto'}}>
           <br></br>
          ...
          <br></br>
          <ToggleButtonGroup type="checkbox" value={1} style={{}}>
            <ToggleButton value={1}>Settings</ToggleButton>
            <ToggleButton value={2}>Report</ToggleButton>
          </ToggleButtonGroup>

        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px'}}>
