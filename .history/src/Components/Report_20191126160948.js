      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', height: '100%', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          ...
          <div style={{ width: '100%', justifyItems: 'space-between'}}>
            <span style={{ color: 'whitesmoke', textAlign: 'left', alignSelf: 'flex-start'}}>Student Log Report for {this.props.courseInfo.short_name}</span>
           
            <Button style={{fontSize: '12px', alignSelf: 'flex-end'}}
                    variant="secondary"
