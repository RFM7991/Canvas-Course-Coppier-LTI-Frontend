      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', height: '100%', margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          ...
          <div style={{ flex: 1, backgroundColor: 'green'}}>
            <div style={{ width: '50%', alignSelf: 'flex-start', flex: 0.5}}>
                <p style={{ color: 'whitesmoke'}}>Student Log Report for {this.props.courseInfo.short_name}</p>
            </div>
            <Button style={{ fontSize: '12px', alignSelf: 'flex-end', flex: 0.5}}
                variant="secondary"
