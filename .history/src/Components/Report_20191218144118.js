...
class Report extends React.Component {
    ...
    render() {
      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', maxHeight: '400px', overflowY: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          ...
          <ReactTableContainer width="80%" height="80vh">
