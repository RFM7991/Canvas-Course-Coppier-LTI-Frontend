    ...
    render() {
      ...
      return (
        <div style={{ fontFamily: 'arial, sans-serif', width: '100%', height: '100%', margin: 'auto', border: '1px solid white', borderRadius: '5px', padding: '8px', display: 'flex', flexDirection: 'column'}}>
          ...
          <div style={{ flex: 1, justifyContent: 'space-between', backgroundColor: 'green'}}>
            <p style={{ color: 'whitesmoke', alignSelf: 'flex-start'}}>Student Log Report for {this.props.courseInfo.short_name}</p>
