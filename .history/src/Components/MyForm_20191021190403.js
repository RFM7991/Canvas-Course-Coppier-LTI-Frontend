...
class MyForm extends React.Component {
   ...
   async handleSubmit() {
      if (this.state.actionTaken) {
        ...
        let response  = await updateCourse(this.props.token, this.props.userInfo.courseId, this.state.checked, this.state.teacher_threshold, this.state.student_threshold)
